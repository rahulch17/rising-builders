<footer>
  <div class="footer-inner">
    <div class="footer-top">
      <div>
        <div class="footer-logo"><img id="footer-logo" src="" alt="Rising Builders & Engineers"/></div>
        <p class="footer-desc">Nepal's trusted design-build partner. Quality construction, transparent delivery, and lasting relationships since 2014.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <ul class="footer-links">
          ...
          <li><a href="#">HVAC & Electrical</a></li>
      ...
      <div>
        ...
        <div class="footer-contact-row">
          ...
          Old Baneshwor-10, Kathmandu, Nepal
        </div>
        <div class="footer-contact-row">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
          info@risingbuilder.com
        </div>
        <div class="footer-contact-row">
          ...
          www.risingbuilder.com
        </div>
      </div>
    </div>
    <div class="footer-bottom">
      <p>© 2024 Rising Builders & Engineers Pvt. Ltd. All rights reserved.</p>
